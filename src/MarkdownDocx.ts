...
import { IBlockAttr, IBlockToken, IInlineToken, IMarkdownStyleConfig, ITextAttr, MarkdownDocxOptions, MarkdownImageItem } from './types'
import { getImageTokens } from './utils'
import { resolveStyleConfig } from './presets'
...
export class MarkdownDocx {
  ...
  public _styleConfig: IMarkdownStyleConfig | undefined
